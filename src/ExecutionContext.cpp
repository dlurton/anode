...
namespace lwnn {
    ...
    std::unique_ptr<llvm::Module> irgenAndTakeOwnership(lwnn::Function &FnAST, const std::string &Suffix);
    ...
    public:
        ...
        llvm::Error addFunctionAST(std::unique_ptr<lwnn::Function> FnAST) {
            ...
            auto SharedFnAST = std::shared_ptr<lwnn::Function>(std::move(FnAST));
